...
const {
    user: userModel, photo: photoModel, tag: tagModel, searchHistory: searchHistoryModel,
} = require("../models");
        ...
        if (userId) {
            ...
            if (!existingHistory) {
                await searchHistoryModel.create({
                    userId, query: tags, timestamp: new Date(),
                });
            }
        }
...
module.exports = {
    validateNewUser, validateUnsplashRequest, validatePhotoData, validateAddTags, validateSearch, validateUserIdQuery,
};
